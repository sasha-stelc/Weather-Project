...
class Images(widget.QWidget):
    def __init__(self, parent=None):
        ...
        frame_layout.setContentsMargins(24, 8, 10, 20)
        ...
        self.ADD_BUTTON.setStyleSheet("background-color: rgba(0,0,0,0.3); color: white; border-radius: 8px ")
        ...
        self.SAVE_BUTTON.setStyleSheet("background-color: rgba(0,0,0,0.3); color: white; border-radius: 8px")
    ...
    def UPDATE_THEME_SELECTION_STYLES(self):
        for folder_name, parts in self.THEME_CARDS.items():
            ...
            parts["frame"].selected = is_selected
